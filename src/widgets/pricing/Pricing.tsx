...
const plans: Plan[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { text: "프리미엄 1개월 무료", included: true },
      { text: "프로필 우선 노출", included: true },
    ],
    buttonText: "전화번호 등록",
  ...
  },
  {
    ...
    heading: "평생 프리미엄",
    price: "평생 ₩29,000",
    originalPrice: "연 ₩118,800",
    discountBanner: "75% 할인 100명 한정",
    features: [
      { text: "출시 즉시 사용", included: true },
      { text: "모든 프리미엄 기능 평생 무료", included: true },
      { text: "무제한 Interested", included: true },
      { text: "고급 필터", included: true },
      { text: "프로필 부스트", included: true },
