...
export function Dashboard() {
  ...
  const actions = [
    { id: "conversion", label: "전환율 올리기" },
    { id: "retention", label: "리텐션 개선" },
    { id: "engagement", label: "참여도 증가" },
  ];
  ...
  return (
    <Card variant="bento" className="p-6 border-white/10">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h3 className="text-lg font-semibold text-white mb-1">대시보드</h3>
          <p className="text-sm text-gray-400">이커머스 · 실시간 모니터링</p>
        </div>
      ...
      {/* 액션 버튼 */}
      <div className="mb-6">
        <p className="text-xs text-gray-500 mb-3 uppercase tracking-wide">추천 액션</p>
      ...
      {selectedAction && (
        <div className="mt-4 p-4 bg-white/5 rounded-lg border border-white/10">
          ...
          <p className="text-xs text-gray-400 leading-relaxed">
            지난 7일간의 데이터 분석 결과, 관련 기능 적용으로 전환율이{" "}
            <span className="text-green-400 font-medium">+12.3%</span> 상승했습니다.
          </p>
        </div>
      )}
