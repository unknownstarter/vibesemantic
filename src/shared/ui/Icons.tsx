 ...
 * Using Lucide-style SVG icons with consistent API
 */
...
export function CsvIcon({ className, size = 24 }: IconProps) {
  return (
    <svg
      className={cn(className)}
      width={size}
...
export function GA4Icon({ className, size = 24 }: IconProps) {
  return (
    <svg
      className={cn(className)}
      width={size}
